...
function createAndShowPopupforSpreading() {
    ...
    okayButton.style.boxShadow = '0px 0px 5px 1px rgba(0,0,0,0.9)';
    okayButton.style.backgroundColor = 'var(--bs-info-text-emphasis)';
    okayButton.style.color = 'rgb(255,255,255)';
