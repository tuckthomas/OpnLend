...
function initializeChatbot() {
    ...
    // Check if the current page is 'Financials.html' or 'income-statement.html'
    var currentPage = window.location.pathname;
    if (currentPage.endsWith('Financials.html') || currentPage.endsWith('income-statement.html')) {
        ...
        var speechBubble = createElement('div', {
            id: 'speechBubble',
            textContent: 'Greetings! I am the OakenOracle, an artifically intelligent entity enlightened in credit and lending, including the SBA SOP! I exist solely to assist you in anything related to credit and lending, as well as provide assistance when learning the OpnLend loan origination system.'
        }, document.body);
    }
}
